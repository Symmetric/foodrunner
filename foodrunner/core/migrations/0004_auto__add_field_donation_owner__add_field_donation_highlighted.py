...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'core.donation': {
            ...
            'highlighted': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'donations'", 'null': 'True', 'to': u"orm['auth.User']"}),
